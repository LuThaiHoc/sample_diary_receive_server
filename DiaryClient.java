...
public class DiaryClient {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Path filePath = Paths.get("path_to_media_file");
    ...
    private static HttpRequest.BodyPublisher ofMimeMultipartData(Map<Object, Object> data, Path filePath) throws IOException {
        ...
        byteArrays.add(("--" + boundary + "\r\nContent-Disposition: form-data; name=\"media\"; filename=\"" + filePath.getFileName() + "\"\r\nContent-Type: " + Files.probeContentType(filePath) + "\r\n\r\n").getBytes());
